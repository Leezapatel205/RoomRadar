    ...
    useEffect(() => {
      const fetchListing = async () => {
        try {
          ...
          const res = await axios.get(`http://localhost:5000/api/listing/get/${listingId}`);
          const data = res.data;
  ...
  const handleRemoveImage = (index) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const token = localStorage.getItem('token'); // Update this based on your authentication method
