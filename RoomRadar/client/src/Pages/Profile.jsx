...
export default function Profile() {
  ...
  const handleSignOut = async () => {
    try {
      ...
      const { data } = await axios.get('http://localhost:5000/api/auth/signout');
  ...
  const handleShowListings = async () => {
    try {
      ...
      const res = await axios.get(`http://localhost:5000/api/listing/user/${currentUser._id}`, {
